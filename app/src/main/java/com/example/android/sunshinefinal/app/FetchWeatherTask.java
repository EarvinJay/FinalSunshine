...
import com.example.android.sunshinefinal.app.data.WeatherContract;
import com.example.android.sunshinefinal.app.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        {
            int locationIdIndex=locationCursor.getColumnIndex(WeatherContract.LocationEntry._COUNT);
